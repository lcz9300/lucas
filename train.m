...
cc=load('test_zzl');	
trian_label=load('F:\Matlabcx\CSP\Motor Imagery\train_label.txt');	
y_test=load('F:\Matlabcx\CSP\Motor Imagery\test_label.txt');	
...
T = extractCSP(EEGSignals, CSPMatrix2, nbFilterPairs); 
